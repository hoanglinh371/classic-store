...
<body>
    ...
    <div class="shop-container">
        <h2>
            <a href="./hats.php">HATS COLLECTION</a>
        </h2>
        ...
        <h2>
            <a href="./jackets.php">JACKETS COLLECTION</a>
        </h2>
        <div class="products-container">
        ...
        <h2>
            <a href="./sneakers.php">SNEAKERS COLLECTION</a>
        </h2>
        <div class="products-container">
        ...
        <h2>
            <a href="./womens.php">WOMEN COLLECTION</a>
        </h2>
        <div class="products-container">
        ...
        <h2>
            <a href="./mens.php">MEN COLLECTION</a>
        </h2>
        <div class="products-container">
